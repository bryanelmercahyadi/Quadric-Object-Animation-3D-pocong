    ...
    class Mesh3
    {
        ...
        public void createEllipsoidVertices()
        {
            ...
            for (float u = -_pi; u <= _pi; u += _pi / 30)
            {
                for (float v = -_pi / 2; v < _pi / 2; v += _pi / 30)
                {
                    ...
                    temp_vector.Y = _positionY + _radius * (float)Math.Cos(v) * (float)Math.Sin(u); // y
        ...
        public void setupObject()
        {
            ...
            _shader_ellipsoid = new Shader("C:/Users/BRYAN/source/repos/Project Grafkom/Project Grafkom/Shaders/shader.vert",
                "C:/Users/BRYAN/source/repos/Project Grafkom/Project Grafkom/Shaders/shader_hitam.frag");
        ...
        //    ////sumbu X
        //    //transform = transform * Matrix4.CreateRotationX(MathHelper.DegreesToRadians(0.005f));
        //}
